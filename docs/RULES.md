...
| 15. | [common/other/accent](../src/rules/common/other/accent.js) | Замена заглавной буквы и добавление знака ударения | 560 |  |  |
...
| 47. | [ru/nbsp/afterNumber](../src/rules/ru/nbsp/afterNumber.js) | Нераз. пробел между числом и словом | 615 |  | ✓ |
...
| 50. | [ru/nbsp/beforeShortLastWord](../src/rules/ru/nbsp/beforeShortLastWord.js) | Нераз. пробел перед последним коротким словом в предложении | 620 |  | ✓ |
...
| 60. | [ru/optalign/bracket](../src/rules/ru/optalign/bracket.js) | Висячая пунктуация для открывающей скобки | 1001 |  |  |
| 61. | [ru/optalign/comma](../src/rules/ru/optalign/comma.js) | Висячая пунктуация для запятой | 1002 |  |  |
| 62. | [ru/optalign/quot](../src/rules/ru/optalign/quot.js) | Висячая пунктуация для открывающей кавычки | 1000 |  |  |
