...
| 21. | [ru/nbsp/twoPartAbbr](../src/rules/ru/nbsp/twoPartAbbr.js) | Нераз. пробел в двухчастных сокращениях, например в т. д. | 565 |  | ✓ |
...
| 28. | [common/nbsp/afterPara](../src/rules/common/nbsp/afterPara.js) | Нераз. пробел после § | 610 |  | ✓ |
