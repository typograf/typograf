...
describe('HTML Entities', function() {
    ...
    it('should get entities as name or digit with method "execute"', function() {
        const tName = new Typograf({ locale: 'ru' });
        const namePrefs: TypografExecutePrefs = { locale: 'en-US', htmlEntity: {type: 'name' }};
        expect(tName.execute('1\u00A02\u00A03', namePrefs)).toEqual('1&nbsp;2&nbsp;3');
        expect(tName.execute('1&#160;2&#160;3', namePrefs)).toEqual('1&nbsp;2&nbsp;3');
        expect(tName.execute('1&#xA0;2&#160;3', namePrefs)).toEqual('1&nbsp;2&nbsp;3');
        expect(tName.execute('1&#xa0;2&#160;3', namePrefs)).toEqual('1&nbsp;2&nbsp;3');
        expect(tName.execute('1&#xa0;2&#xa0;3', namePrefs)).toEqual('1&nbsp;2&nbsp;3');

        const tDigit = new Typograf({ locale: 'ru' });
        const digitPrefs: TypografExecutePrefs = { locale: 'en-US', htmlEntity: { type: 'digit' }};
        expect(tDigit.execute('1\u00A02\u00A03', digitPrefs)).toEqual('1&#160;2&#160;3');
        expect(tDigit.execute('1&nbsp;2&nbsp;3', digitPrefs)).toEqual('1&#160;2&#160;3');
        expect(tDigit.execute('1&#xa0;2&nbsp;3', digitPrefs)).toEqual('1&#160;2&#160;3');
        expect(tDigit.execute('1&#xa0;2&#160;3', digitPrefs)).toEqual('1&#160;2&#160;3');
        expect(tDigit.execute('1&#xa0;2&#xa0;3', digitPrefs)).toEqual('1&#160;2&#160;3');
